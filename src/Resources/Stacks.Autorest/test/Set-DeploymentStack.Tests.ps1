if(($null -eq $TestName) -or ($TestName -contains 'Set-DeploymentStack'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'Set-DeploymentStack.Recording.json'
