if(($null -eq $TestName) -or ($TestName -contains 'New-DeploymentStack'))
{
  ...
  . ($loadEnvPath)
  $TestRecordingFile = Join-Path $PSScriptRoot 'New-DeploymentStack.Recording.json'
