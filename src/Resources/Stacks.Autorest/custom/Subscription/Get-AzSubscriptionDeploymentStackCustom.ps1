...
function Get-AzSubscriptionDeploymentStackCustom {
    ...
    [CmdletBinding(DefaultParameterSetName='ListDeploymentStacks', PositionalBinding, SupportsShouldProcess, ConfirmImpact='Medium')]
    ...
    process {
        if ($PSBoundParameters.ContainsKey("ResourceId")) { 
            # TODO: Build utility functions
            # $PSBoundParameters["Name"] = implement utility
        }
