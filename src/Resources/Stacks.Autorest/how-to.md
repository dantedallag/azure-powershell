# How-To
This document describes how to develop for `DeploymentStacks`.

## Building `DeploymentStacks`
...
- `run-module.ps1`
  - Creates an isolated PowerShell session and loads `DeploymentStacks` into the session.
