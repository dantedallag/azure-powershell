...
namespace Microsoft.Azure.Commands.ResourceManager.Cmdlets.Implementation
{
    ...
    [Cmdlet("Test", Common.AzureRMConstants.AzureRMPrefix + "ManagementGroupDeploymentStack",
        SupportsShouldProcess = true, DefaultParameterSetName = ParameterlessTemplateFileParameterSetName), OutputType(typeof(PSDeploymentStackValidationError))]
        ...
        protected override void OnProcessRecord()
        {
            try
            {
                ...
                if (DeploymentSubscriptionId != null)
                {
                    ...
                    WriteObject(DeploymentStacksSdkClient.ManagementGroupValidateDeploymentStack(
